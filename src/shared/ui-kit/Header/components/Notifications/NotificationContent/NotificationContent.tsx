  ...
  return (
    <>
      {type === 1 ? (
        ...
        <div>
          <div>
            Your blocked NFT <span className={classes.nftName}>{externalData.nft.name}</span> is was fully
            Paid and is now unblocked.
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
        ...
        <div>
          <div>
            The NFT <span className={classes.nftName}>{externalData.nft.name}</span> is now fully paid and
            unblocked. You are now the owner.
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
        ...
        <div>
          <div>
            Your blocked NFT <span className={classes.nftName}>{externalData.nft.name}</span> is has expired
            to to NFT and claim the collateral and NFT back
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
            Go to your NFT Reserve
          </b>
        ...
        <div>
          <div>
            <span className={classes.username}>{externalData.user}</span> has canceled the NFT Reserve on{" "}
            <span className={classes.nftName}>{externalData.nft.name}</span>. Your offer was canceled with it
            and collateral returned.
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
        ...
        <div>
          <div>
            You have successfully accepted Blocking offer of{" "}
            <span className={classes.username}>{externalData.user}</span> for your NFT{" "}
            <span className={classes.nftName}>{externalData.nft.name}</span>.
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
            Go to your NFT Reserve
        ...
        <div>
          <div>
            <span className={classes.username}>{externalData.user}</span> just accepted your NFT{" "}
            {externalData.price} USDT Blocking offer for{" "}
            <span className={classes.nftName}>{externalData.nft.name}</span>
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
            Go to your management
        ...
        <div>
          <div>
            Congrats! <span className={classes.nftName}>{externalData.nft.name}</span> you blocked is now
            fully paid and available to claim.
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
            Go to NFT
          </b>
        ...
        <div>
          <div>
            Your blocked NFT <span className={classes.nftName}>{externalData.nft.name}</span> succesfully
            claimed by <span className={classes.username}>{externalData.user}</span> and transferred to the
            new owner.
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
            Go to your NFT Reserve
        ...
        <div>
          <div>
            Your have succesfully claimed <span className={classes.nftName}>{externalData.nft.name}</span> NFT
            and you are now the owner. Congrats!
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
            Go to your management
          </b>
        ...
        <div>
          <div>
            <span className={classes.username}>{externalData.user}</span> has accepted your offer on{" "}
            <span className={classes.nftName}>{externalData.nft.name}</span>. Go to your NFT to see your
            purchase
          </div>
          <b style={{ color: "rgba(233, 255, 38, 1)" }} onClick={() => goToNFTDetail()}>
